package io.bandi.gamelens.session.client;
 ...
 *
 * <p>Used exclusively to verify game existence before session operations.
 */
@Component
public class SessionClient {
    ...
    public SessionClient(RestClient sessionRestClient) {
